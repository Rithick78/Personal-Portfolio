  ...
  return (
    <div className='mb-25'>
      <div className='lg:grid lg:grid-cols-3 flex flex-col'>
        <div className='hidden lg:block lg:h-190 h-160'>
          <Lanyard position={[0, 0, 20]} gravity={[0, -40, 0]} />
        </div>
        <div className='flex justify-center lg:hidden relative z-10 mb-10 mt-20 '>
          <img src="/rithickRJ.png" className='rounded-b-[110px]  sm:w-100 sm:h-110 w-70 h-90 '/>
        </div>
