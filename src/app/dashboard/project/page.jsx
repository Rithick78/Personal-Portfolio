...
function Projects() {
  ...
  const Projects = [
    ...
    },
    {
      ...
      description: (
        <>
          <h1 className='font-extrabold md:text-md sm:text-sm text-[10px]'>Built a high-performance portfolio website to showcase projects, technical skills, and achievements, combining modern UI design with smooth animations and a responsive layout.</h1>
    ...
    },
    {
      ...
      description: (
        <>
          <h1 className='font-extrabold md:text-md sm:text-sm text-[10px]'>Created a simple portfolio website while learning web development, showcasing personal projects and technologies used.</h1>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Built with React and CSS to practice component-based design and styling.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Highlighted projects and technical skills in a clean, minimal layout.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Designed a responsive interface to ensure accessibility across devices.</p>
        </>
      ),
      badge: [
        {
    ...
    },
    {
      ...
      description: (
        <>
          <h1 className='font-extrabold md:text-md sm:text-sm text-[10px]'>Developed a To-Do List web application to practice CRUD operations and strengthen core React development skills.</h1>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Built with React and CSS for component-based design and clean styling.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Implemented full CRUD functionality (create, read, update, delete) for task management.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Designed a simple and responsive UI for smooth task organization across devices.</p>
        </>
      ),
      badge: [
        {
    ...
    },
    {
      ...
      description: (
        <>
          <h1 className='font-extrabold'>Built a weather application using React and CSS to display real-time temperature data for locations worldwide.</h1>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Implemented a search feature to fetch weather details by city name.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Used the Fetch API to retrieve and display live data from a weather API.</p>

          <p className="flex items-center gap-2 font-semibold text-gray-400 md:text-md sm:text-sm text-[10px]"><GiStarShuriken className="text-[#ADFF2F]" />Designed a clean, responsive UI for accessibility across all devices.</p>
        </>
      ),
      badge: [
        {
  ...
  const CategorySection = ["All", "Development", "UI Design"]
  const [activeCategory, setActiveCategory] = useState("All")

  const FilterCategory = Projects.filter((item) =>
    activeCategory === "All" || item.category === activeCategory)

  return (
    <div className='pt-40 pb-10 flex flex-col justify-center items-center'>
      <h1 className='flex items-center gap-2 text-[#ADFF2F] roboto font-semibold'><GiBoomerangSun className='animate-spin' /> <ShinyTextTitle
        text="My Projects"
        disabled={false}
        speed={10}
