...
function Header() {
    ...
    return (
        <div className='fixed w-full z-50 flex  items-center justify-between text-white py-7 px-7 md:px-12 lg:px-25 xl:px-50 2xl:px-75'>
            ...
            <div className={`absolute md:top-0 md:right-0 ${openMenu ? "top-18 right-3": "-top-100 right-3"} ease-in transition-all md:static flex flex-col md:flex-row gap-10 text-[12px] bg-[black]/20 border-[white]/10 border py-3 px-10 rounded-4xl`}>
